...
if {![info exists ::env(NO_CLOCK)]} { create_clock -name clk -period $period -waveform [list 0.0 $half] [get_ports $clkport] }
if {[info exists ::env(CLK2_PORT)] && ![info exists ::env(NO_CLOCK)]} {                                               ;# optional second (asynchronous) clock, e.g. the 32.768 kHz clock of the front end
...
if {[llength [all_clocks]]} { set_propagated_clock [all_clocks] }
file mkdir $OUT
