...
for v in "_o3 -O3 bmi_snn_sw.c" "_tuned -O3 bmi_snn_sw_tuned.c"; do set -- $v
  ...
  CYCLES_OUT=results/riscv_cycles$1.json .venv/bin/python sw/riscv_cycles_fast.py sim/build_riscv_gls$1/riscv_gls$1.vcd 16 > logs/riscv_cycles$1.log 2>&1; grep -E "cycles_per_bin|decode_cycles" results/riscv_cycles$1.json | head -2
done
echo "E4 DONE $(date)"
