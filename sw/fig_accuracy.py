...
NB = {"ANN 2D (NeuroBench)": None, "SNN3 (NeuroBench)": [0.6968, 0.5772, 0.6517], "SNN2 streaming (NeuroBench)": [0.6774, 0.5011, 0.5994]}
...
ax.legend(fontsize=6.5, loc="upper left", frameon=False, ncol=1)
fig.tight_layout(); fig.savefig(FIG / "r2.pdf"); fig.savefig(FIG / "r2.png", dpi=200)
